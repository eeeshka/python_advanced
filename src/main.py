...
# Урок 19: Решение задачи от тимлида - Собственные исключения
...
# Практика: Задание 1 - Создание исключения NegativePriceError
# Исключение уже создано в src/models/exceptions.py
try:
    product = Product("Ноутбук", -50000, 10)
except NegativePriceError as e:
    print("Ошибка валидации:", e)

# Практика: Задание 2 - Иерархия исключений
# Создание товара с отрицательной ценой
try:
    product = Product("Ноутбук", -50000, 10)
except NegativePriceError as e:
    print("Ошибка валидации:", e)
except ValidationError as e:
    print("Общая ошибка валидации:", e)

# Попытка продать больше товара, чем есть
try:
    product = Product("Ноутбук", 50000, 10)
    product.sell(100)
    ...
    print("Общая ошибка бизнес-логики:", e)
